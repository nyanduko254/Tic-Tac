...
//        }
    ...
    private void player1Wins() {
        player1Points++;
        Toast.makeText(MegaSinglePlayerActivity.this, "Hurray! Player 1 wins!", Toast.LENGTH_LONG).show();
        updatePointsText();
        resetBoard();
    }
    ...
    private void player2Wins() {
        player2Points++;
        Toast.makeText(MegaSinglePlayerActivity.this, "Yaay! Player 2 takes it!", Toast.LENGTH_LONG).show();
        updatePointsText();
        resetBoard();
    }
