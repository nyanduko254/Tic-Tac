...
public class MegaTwoPlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void player1Wins() {
        player1Points++;
        Toast.makeText(MegaTwoPlayerActivity.this, "Hurray! Player 1 wins!", Toast.LENGTH_LONG).show();
        updatePointsText();
        resetBoard();
    }
    ...
    private void player2Wins() {
        player2Points++;
        Toast.makeText(MegaTwoPlayerActivity.this, "Yaay! Player 2 takes it!", Toast.LENGTH_LONG).show();
        updatePointsText();
        resetBoard();
    }
